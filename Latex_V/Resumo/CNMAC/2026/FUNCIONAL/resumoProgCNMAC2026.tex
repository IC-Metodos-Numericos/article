...
Bib\LaTeX{}. \verb+refs.bib+ \verb+\cite+. Seguem alguns exemplos de referências: livros ~\cite{Chapra}, ~\cite{Faires}, ~\cite{Vera}, e outros ~\cite{CNMAC}. Sempre que disponível forneça o DOI, ISBN ou ISSN, conforme o caso.
