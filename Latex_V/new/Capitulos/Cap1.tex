...
Diferente dos conjuntos matatemáticos comuns (\mathbb{R}, \mathbb{Z}, etc.), todo conjunto de números de um sistema de ponto flutuante é, por natureza, discreto, ou seja, possui uma quantidade finita de números representáveis. Unidades de última posição, as ULP's é o nome dado ao intervalo
