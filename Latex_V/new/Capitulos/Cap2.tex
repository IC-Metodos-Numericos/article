...
\HACK{Espaçamento entre os "..." ficou meio porco, se alguém souber como melhorar}
\begin{equation*}
    \begin{cases}
...
\end{equation}
Podemos definir a matriz Jacobiana \(J\) de \(F\) como
\begin{equation}
    J(\mathbf{p}) =
    \begin{bmatrix}
...
% COM O CALCULO DO DETERMINANTE E DA INVERSA
% \begin{align*}
%     \begin{bmatrix}
%         x_{k+1} \\[6pt]
%         y_{k+1}
...
% \[
% \det(J) = (2x_k)(-1) - (2x_k)(2y_k) = -2x_k - 4x_ky_k
% \]

% \[
% J(x_k,y_k)^{-1}
% = \frac{1}{-2x_k - 4x_k y_k}
% \begin{bmatrix}
% -1 & -2y_k \\[6pt]
% -2x_k & 2x_k
% \end{bmatrix}.
...
\TODO{Adicionar Imagem do plano complexo}
