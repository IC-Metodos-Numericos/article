...
\begin{minipage}[t]{0.31\textwidth}
  ...
  \parbox{24cm}{
    {
      \textbf{Figura 1:} Perda de significância com de 32 bits.
    }
  }
  \vspace{1cm}
  ...
  \parbox{24cm}{
    {
      \textbf{Figura 2:} Erro de cancelamento catastrófico com precisão de 64 bits.
    }
  }
...
\begin{minipage}[t]{0.31\textwidth}
  ...
  \parbox{24cm}{
    {
    \textbf{Figura 3:} Gráfico das funções p e q com precisão de 64 bits.
    }
  }
  \vspace{1cm}
  ...
  \parbox{24cm}{
    {
      \textbf{Figura 4:} Erro de aproximação da Derivada em 32 bits.
    }
  }
